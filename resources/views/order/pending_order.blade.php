...
<body>
    ...
    <body>
        ...
        @endif
        <div class="container">
            <h3>Total Pending order:{{ sizeof($orders) }}</h3>
        </div>
                            ...
                            <div class="card-body p-2">
                                <div class="row d-flex justify-content-between align-items-center">
                                    <div class="col-md-2 col-lg-2 col-xl-2">
                                        <img src="{{ asset('storage/images/' . $item['image_url']) }}"
                                    ...
                                    <div class="col-md-3 col-lg-3 col-xl-3">
                                        ...
                                        <p><span class="text-muted">Item
                                            ...
                                            <span class="text-muted">Placed
                                                At:</span>{{ $item['created_at'] }}<br>
                                    ...
                                    <div class="col-md-3 col-lg-3 col-xl-2">
                                        ...
                                        <button class="btn btn-primary">
                                            <a class="text-decoration-none text-white"
                                                href="{{ '/receive-order/' . $item['id'] }}">Deliver Order</a>
                                        </button>
